...
<body>
  ...
  <center>
  <a id="btnagregar" href = "agregar_usuarios.php">Agregar Usuarios</a>
</center>
  <center>
  <table>
    <thead>
    ...
    <?php while($mostrar = mysqli_fetch_array($resultado)){ ?>
      <tr>
        ...
        <td>
          <a id="btneditar" href = "editar_usuarios.php?id=<?php echo $mostrar['ID']?>">Editar</a>
          <form action="eliminar_usuarios.php" method = "post"> <input type="hidden" value="<?php echo $mostrar['ID'] ?>" name="txtID"readonly>
